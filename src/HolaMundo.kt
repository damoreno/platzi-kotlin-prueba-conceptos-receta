...
fun lista(){
    val months: HashMap<String,Int> = hashMapOf("Enero" to 1, "Febrero" to 2, "Marzo" to 3, "Abril" to 4, "Mayo" to 5, "Junio" to 6,
            "Julio" to 7, "Agosto" to 8, "Septiembre" to 9, "Octubre" to 10, "Noviembre" to 11,
            "Diciembre" to 12)


    println({valor: Int->hashMapOf(1 to "Enero", 2 to "Febrero").getValue(valor)}(2))
    println(months.get("Enero"))
